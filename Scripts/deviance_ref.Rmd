...
election_full <- read.xlsx(here("Data", "Election_data", "precinct_results_2020.xlsx"))
...
election_full <- election_full %>% mutate(ur_last = yes %% 10)
...
```{r}
write.csv(precincts, here("Data", "region_deviance_2020.csv"))
```
