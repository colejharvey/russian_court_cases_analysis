...
election_full <- read.xlsx(here("Data", "Election_data", "precinct_results_2016.xlsx"))
...
```{r}
# write.csv(precincts, here("Data", "region_deviance_2021.csv")) #Do not overwrite--treated_fine values manually input
```
